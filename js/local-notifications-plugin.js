var capacitorLocalNotifications = (function (exports, core) {
    ...
    const LocalNotifications = (core && typeof core.registerPlugin === 'function')
        ? core.registerPlugin('LocalNotifications', {
            web: () => Promise.resolve().then(function () { return web; }).then((m) => new m.LocalNotificationsWeb()),
        })
        : (core && core.Plugins && core.Plugins.LocalNotifications ? core.Plugins.LocalNotifications : {});
